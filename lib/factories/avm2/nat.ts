...
export function describeTypeJSON(sec: AXSecurityDomain, value: any, flags: number) {
  return describeTypeJSON(sec, value, flags);
}

var nativeClasses: MapObject<ASClass> = ObjectUtilities.createMap<ASClass>();
var nativeFunctions: MapObject<Function> = ObjectUtilities.createMap<Function>();
...
var builtinNativeClasses: MapObject<ASClass> = ObjectUtilities.createMap<ASClass>();
var nativeClasses: MapObject<ASClass> = ObjectUtilities.createMap<ASClass>();
