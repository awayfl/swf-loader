...
export class SimpleButton extends InteractiveObject {
  ...
  constructor(upState?: DisplayObject,
  ...
  private _currentState: DisplayObject;
...
export class ButtonState {
  constructor(public symbol: DisplaySymbol,
              public placeObjectTag: PlaceObjectTag) {
  }
}
...
export class ButtonSymbol extends DisplaySymbol {
  ...
  constructor(data: SymbolData, loaderInfo: LoaderInfo) {
    super(data, SimpleButton.axClass, true);
  ...
  static FromData(data: any, loaderInfo: LoaderInfo): ButtonSymbol {
    ...
    var character: DisplaySymbol = null;
    ...
    for (var stateName in states) {
      ...
      if (controlTags.length === 1) {
        ...
        character = <DisplaySymbol>loaderInfo.getSymbolById(placeObjectTag.symbolId);
        if (!character) {
          continue;
        }
      } else {
