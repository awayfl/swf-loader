...
import {
	alCoerceNumber, alCoerceString, alDefineObjectProperties, alNewObject, alToBoolean
} from "../runtime";
...
export class AVM1SharedObject extends AVM1Object {
	private _as3SharedObject: SharedObject;

	constructor(context: AVM1Context, as3SharedObject:SharedObject) {
		super(context);
